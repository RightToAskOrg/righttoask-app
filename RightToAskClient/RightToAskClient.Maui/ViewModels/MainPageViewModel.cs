...
namespace RightToAskClient.Maui.ViewModels
{
    public class MainPageViewModel : BaseViewModel
    {
        ...
        public MainPageViewModel()
        {
            ...
            // commands
            TrendingNowButtonCommand = new RelayCommand(async () =>
            {
                //App.ReadingContext.TrendingNow = true;
                //App.ReadingContext.IsReadingOnly = true;
                await Shell.Current.GoToAsync($"{nameof(ReadingPage)}");
            });
            ExpiringSoonButtonCommand = new RelayCommand(async () =>
            {
                //App.ReadingContext.TrendingNow = true;
                //App.ReadingContext.IsReadingOnly = true;
                await Shell.Current.GoToAsync($"{nameof(ReadingPage)}");
            });
            DraftingButtonCommand = new RelayCommand(async () =>
            {
            ...
            AdvancedSearchButtonCommand = new RelayCommand(async () =>
            {
                //App.ReadingContext.IsReadingOnly = true;
            ...
            SearchButtonCommand = new RelayCommand(async () =>
            {
                //App.ReadingContext.IsReadingOnly = true;
                //await Shell.Current.GoToAsync($"{nameof(ReadingPage)}");
            });
        ...
        // commands
        public IRelayCommand TrendingNowButtonCommand { get; }
        public IRelayCommand ExpiringSoonButtonCommand { get; }
        public IRelayCommand DraftingButtonCommand { get; }
        public IRelayCommand AdvancedSearchButtonCommand { get; }
        public IRelayCommand SearchButtonCommand { get; }
    }
}
