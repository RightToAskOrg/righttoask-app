---
name: Xamarin.Forms - RightToAskClient
description: 'This sample demonstrates a RightToAskClient list application where the data is stored and accessed in a local SQLite database (get started)'
page_type: sample
languages:
- csharp
products:
